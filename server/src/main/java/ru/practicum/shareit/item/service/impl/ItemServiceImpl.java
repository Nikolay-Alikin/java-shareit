...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDTO createItem(Long xSharerUserId, ItemDTO itemDTO) {
        ...
        if (itemDTO.getRequestId() != null) {
            entity.setRequestEntity(findRequestEntity(itemDTO.getRequestId()));
        }
    ...
    public ItemDTO updateItem(Long xSharerUserId, Long itemId, ItemDTO itemDTO) {
        ...
        if (itemDTO.getRequestId() != null) {
            itemEntity.setRequestEntity(findRequestEntity(itemDTO.getRequestId()));
        }
    ...
    private RequestEntity findRequestEntity(Long id) {
        return requestRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("реквест не найден. id=" + id));
    }
}
